...
export const LEVELS: Level[] = [
  {
    ...
    soilColor: '#8B4513',
    plantSize: 'text-2xl',
    description: ' بدأت الرحلة! أنت بذرة صغيرة تنتظر أن تنمو.',
  },
  {
    level: 2,
    name: 'البرعم',
    ...
    soilColor: '#A0522D',
    plantSize: 'text-3xl',
    description: 'بدأت تنمو! أنت برعم صغير يستمد من الشمس.',
  },
  {
    level: 3,
    name: 'النبتة',
    ...
    soilColor: '#6B8E23',
    plantSize: 'text-4xl',
    description: 'أنت نبتة قوية! أوراقك تزداد يوماً بعد يوم.',
  },
  {
    level: 4,
    name: 'الشجرة الصغيرة',
    ...
    soilColor: '#228B22',
    plantSize: 'text-5xl',
    description: 'أنت شجرة صغيرة! فروعك تنمو كل يوم.',
  },
  {
    level: 5,
    name: 'الشجرة الكبيرة',
    ...
    soilColor: '#006400',
    plantSize: 'text-6xl',
    description: 'أنت شجرة ضخمة! تقدم الظل للجميع.',
  },
  {
    level: 6,
    name: 'الحديقة',
    ...
    soilColor: '#32CD32',
    plantSize: 'text-7xl',
    description: 'لقد وصلت! حديقتك مزهرة وجميلة.',
  },
];
