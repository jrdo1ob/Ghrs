          ...
          >
            ...
            <div className="p-6">
              ...
              >
                ...
                <div className="flex items-center gap-6">
                  <div className="flex items-center gap-2">
                    <StarIcon
                      size={24}
                      color={canAffordXp ? 'var(--ghrs-amber-600)' : 'var(--ghrs-red-500)'}
                    />
                    <div>
                      <p
                  ...
                  {gift.cost_money > 0 && (
                    <div className="flex items-center gap-2">
                      <CoinIcon
                        size={24}
                        color={canAffordMoney ? 'var(--ghrs-green-600)' : 'var(--ghrs-red-500)'}
                      />
                      <div>
                        <p
                          className="text-xl font-bold"
              ...
              <div
                ...
                style={{
                  background: canAfford ? 'var(--ghrs-green-50)' : 'var(--ghrs-red-50)',
                  border: `1px solid ${canAfford ? 'var(--ghrs-green-200)' : 'var(--ghrs-red-200)'}`,
                }}
              >
                <p
                  className="text-sm font-bold"
                  style={{ color: canAfford ? 'var(--ghrs-green-700)' : 'var(--ghrs-red-600)' }}
                >
                  {canAfford
                    ? '✓ رصيدك كافٍ لطلب هذه المكافأة!'
                    : '✗ رصيدك غير كافٍ لطلب هذه المكافأة'}
                </p>
              ...
              >
                {redeeming === gift.id ? (
                  ...
                  <>
                    <GiftsIcon size={20} /> طلب المكافأة
                  </>
                ) : (
                  <>
                    <LockIcon size={20} /> رصيد غير كافٍ
                  </>
                )}
              </button>
            </div>
