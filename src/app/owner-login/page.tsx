      ...
      <div className="w-full max-w-md">
        ...
        <div className="ghrs-card p-8">
          ...
          <div className="flex items-center gap-4 my-6">
            ...
            <span className="text-sm" style={{ color: 'var(--ghrs-text-tertiary)' }}>
              أو
            </span>
            <div className="flex-1 h-px" style={{ background: 'var(--ghrs-border-default)' }} />
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3 px-6 rounded-xl font-bold transition-colors disabled:opacity-50"
            style={{
