        ...
        <div className="p-4 md:p-8 max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
            ...
            <Link href="/approvals" className="ghrs-card p-4 ghrs-card-interactive">
              <div className="flex items-center gap-3">
                <div
                  ...
                  style={{
                    background:
                      pendingApprovals > 0 ? 'var(--ghrs-amber-50)' : 'var(--ghrs-bg-secondary)',
                  }}
                >
                  <ClockIcon
                    size={20}
                    color={
                      pendingApprovals > 0 ? 'var(--ghrs-amber-600)' : 'var(--ghrs-text-tertiary)'
                    }
                  />
                </div>
                <div className="min-w-0 flex-1">
                  <div className="flex items-baseline gap-2">
                    ...
                    {pendingApprovals > 0 && (
                      <span className="text-[10px] font-bold px-1.5 py-0.5 rounded ghrs-badge ghrs-badge-warning">
                        جديد
                      </span>
                    )}
                  </div>
            ...
            <div className="ghrs-card p-4">
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  <p
                    className="text-sm font-bold font-mono leading-none truncate"
                    style={{ color: 'var(--ghrs-text-primary)' }}
                  >
                    {family?.code}
                  </p>
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-3">
              <h2 className="text-base font-bold" style={{ color: 'var(--ghrs-text-primary)' }}>
                أبنائي
              </h2>
              {children.length > 0 && (
                <Link
                      ...
                      >
                        <div className="flex items-center gap-2">
                          ...
                          >
                            ...
                            {child.pendingApprovals === 1
                              ? 'طلب بانتظار الموافقة'
                              : child.pendingApprovals === 2
                                ? 'طلبان بانتظار الموافقة'
          ...
          {/* Quick actions */}
          <div className="mb-6">
            <h2 className="text-base font-bold mb-3" style={{ color: 'var(--ghrs-text-primary)' }}>
              الوصول السريع
            </h2>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
              ...
              <Link href="/stories" className="ghrs-card p-3 ghrs-card-interactive">
                <div className="flex items-center gap-3">
                  <div
                    className="w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0"
                    style={{ background: 'var(--ghrs-purple-50)' }}
                  >
          ...
          <div className="mt-4 flex justify-center">
            <button
              ...
              className="ghrs-btn-secondary text-ghrs-red-600"
