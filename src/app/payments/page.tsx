    ...
    <div className="min-h-screen" style={{ background: 'var(--ghrs-bg-primary)' }}>
      ...
      <div className="md:mr-[var(--ghrs-sidebar-width)] pb-24 md:pb-8">
        <div className="p-4 md:p-8 max-w-4xl mx-auto">
          <PageHeader title="الأموال" subtitle="متابعة المعاملات المالية" backHref="/dashboard" />
                ...
                <div className="flex justify-between items-start gap-3">
                  <div className="flex items-center gap-3 min-w-0 flex-1">
                    <div
                      ...
                      style={{
                        ...
                        border: `1px solid ${tx.type === 'earned' ? 'var(--ghrs-green-200)' : 'var(--ghrs-amber-200)'}`,
                      }}
                    >
                      <CoinIcon
                        size={16}
                        color={
                          tx.type === 'earned' ? 'var(--ghrs-green-600)' : 'var(--ghrs-amber-600)'
                        }
                      />
                    </div>
                  ...
                  <div className="text-left flex-shrink-0">
                    <p
                      ...
                      style={{
                        color:
                          tx.type === 'earned' ? 'var(--ghrs-green-600)' : 'var(--ghrs-red-600)',
                      }}
                    >
                      {tx.type === 'earned' ? '+' : '-'}
                      {fmtMoney(tx.amount)}
                    ...
                    <span
                      className={`inline-block mt-1 px-1.5 py-0.5 rounded text-[10px] font-bold ghrs-badge ${
                        tx.status === 'paid'
                          ? 'ghrs-badge-success'
                          : tx.status === 'pending'
                            ? 'ghrs-badge-warning'
