        ...
        <div className="md:mr-[var(--ghrs-sidebar-width)] pb-24 md:pb-8 p-4 md:p-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="ghrs-card p-6 text-center">
              ...
              <Link href="/children" className="ghrs-btn-primary inline-block mt-4">
                العودة للأبناء
              </Link>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
            <div className="ghrs-card p-4 text-center">
              ...
              <p className="text-xl font-bold" style={{ color: 'var(--ghrs-text-primary)' }}>
                {xp}
              </p>
                ...
                {taskHistory.map((t: any) => (
                  <div key={t.id} className="ghrs-card p-3 flex items-center justify-between">
                    <div className="flex items-center gap-2 min-w-0">
                      <CheckIcon
                        size={16}
                        color={t.approved ? 'var(--ghrs-green-500)' : 'var(--ghrs-text-tertiary)'}
                      />
                      <span
                    ...
                    <span
                      ...
                      style={{
                        color: t.approved ? 'var(--ghrs-green-600)' : 'var(--ghrs-amber-500)',
                      }}
                    >
                ...
                {xpHistory.slice(0, 10).map((t: any, i: number) => (
                  <div key={i} className="ghrs-card p-3 flex items-center justify-between">
                    ...
                    <span
                      ...
                      style={{
                        color: t.amount > 0 ? 'var(--ghrs-green-600)' : 'var(--ghrs-red-600)',
                      }}
                    >
                      {t.amount > 0 ? '+' : ''}
                      {t.amount} XP
