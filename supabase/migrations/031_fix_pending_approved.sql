-- Migration 031: Fix complete_task_with_rewards to set approved=NULL for pending
-- The RPC was setting approved=FALSE instead of approved=NULL for tasks requiring approval
